...
@Component({
  selector: 'c-textarea',
  templateUrl: './c-textarea.component.html',
  styleUrls: ['./c-textarea.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
})
export class CTextareaComponent implements OnInit {
  ...
  set input(input: string | number) {
    ...
    if (input)
      this.onSetTimeout(0, () => {
        this.selectFormGroup.setValue({ input });
      });
